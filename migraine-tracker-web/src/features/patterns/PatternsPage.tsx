    ...
    <Layout>
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-start justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Migraine Correlation Patterns</h1>
              ...
              <Card key={pattern.patternType}>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                      <p className="text-xs text-gray-500 mb-1">Avg on Migraine Days</p>
                    ...
                    <div>
                      <p className="text-xs text-gray-500 mb-1">Avg on Normal Days</p>
                    ...
                    <div>
                      <p className="text-xs text-gray-500 mb-1">Migraine Days Analyzed</p>
                      <p className="text-lg font-semibold text-gray-900">
                        {pattern.migraineDaysCount}
                      </p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-500 mb-1">Total Days Analyzed</p>
                      <p className="text-lg font-semibold text-gray-900">
